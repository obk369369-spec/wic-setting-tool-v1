...
console.log(JSON.stringify({status:'PASS',wrapper_contract:'PASS',semantic_runtime:'PASS',renderer_runtime:'PASS',strict_full:format.status,toc_lines:expected.reports.map(x=>x.toc_lines.length),full_body_sha256:format.output_sha256,only_external_input:missing.reason},null,2));
